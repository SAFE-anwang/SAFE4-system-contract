...
abstract contract Constant {
    ...
    address internal constant MASTERNODE_STORAGE_ADMIN_ADDR = 0x0000000000000000000000000000000000001021;
    address internal constant MASTERNODE_STORAGE_PROXY_ADDR= 0x0000000000000000000000000000000000001022;

    address internal constant MASTERNODE_LOGIC_ADDR = 0x0000000000000000000000000000000000001025;
    address internal constant MASTERNODE_LOGIC_ADMIN_ADDR = 0x0000000000000000000000000000000000001026;
    address internal constant MASTERNODE_LOGIC_PROXY_ADDR= 0x0000000000000000000000000000000000001027;

    address internal constant SUPERNODE_STORAGE_ADDR = 0x0000000000000000000000000000000000001030;
    address internal constant SUPERNODE_STORAGE_ADMIN_ADDR = 0x0000000000000000000000000000000000001031;
    address internal constant SUPERNODE_STORAGE_PROXY_ADDR= 0x0000000000000000000000000000000000001032;

    address internal constant SUPERNODE_LOGIC_ADDR = 0x0000000000000000000000000000000000001035;
    address internal constant SUPERNODE_LOGIC_ADMIN_ADDR = 0x0000000000000000000000000000000000001036;
    address internal constant SUPERNODE_LOGIC_PROXY_ADDR= 0x0000000000000000000000000000000000001037;
