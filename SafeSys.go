...
func (_SafeSys *SafeSysCaller) GetBalance(opts *bind.CallOpts, _addr common.Address) (*big.Int, error) {
	var out []interface{}
	err := _SafeSys.contract.Call(opts, &out, "getBalance", _addr)
...
//
// Solidity: function getBalance(address _addr) view returns(uint256)
func (_SafeSys *SafeSysSession) GetBalance(_addr common.Address) (*big.Int, error) {
	return _SafeSys.Contract.GetBalance(&_SafeSys.CallOpts, _addr)
}

// GetBalance is a free data retrieval call binding the contract method 0xf8b2cb4f.
//
// Solidity: function getBalance(address _addr) view returns(uint256)
func (_SafeSys *SafeSysCallerSession) GetBalance(_addr common.Address) (*big.Int, error) {
	return _SafeSys.Contract.GetBalance(&_SafeSys.CallOpts, _addr)
}
...
// GetNextMN is a free data retrieval call binding the contract method 0xa08183c2.
//
// Solidity: function getNextMN() view returns(address)
func (_SafeSys *SafeSysCaller) GetNextMN(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _SafeSys.contract.Call(opts, &out, "getNextMN")
...
//
// Solidity: function getNextMN() view returns(address)
func (_SafeSys *SafeSysSession) GetNextMN() (common.Address, error) {
	return _SafeSys.Contract.GetNextMN(&_SafeSys.CallOpts)
}

// GetNextMN is a free data retrieval call binding the contract method 0xa08183c2.
//
// Solidity: function getNextMN() view returns(address)
func (_SafeSys *SafeSysCallerSession) GetNextMN() (common.Address, error) {
	return _SafeSys.Contract.GetNextMN(&_SafeSys.CallOpts)
}
