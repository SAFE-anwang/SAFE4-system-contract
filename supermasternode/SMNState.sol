...
contract SMNState {
    ...
    mapping(bytes20 => Entry[]) id2states;

    function uploadState(bytes20[] memory _ids, uint8[] memory _states, uint total) public {
    ...
    function existCaller(bytes20 _id, address _caller) internal view returns (bool, uint) {
    ...
    function updateState(bytes20 _id, uint8 _state, uint total) internal {
