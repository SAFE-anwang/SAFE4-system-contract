...
interface IAccountManager {
    ...
    function getLockedAmount(address _addr) external view returns (uint, uint[] memory);
    function getUsedAmount(address _addr) external view returns (uint, uint[] memory);
